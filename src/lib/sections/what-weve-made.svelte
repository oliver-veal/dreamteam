<section class="w-full flex flex-col p-5 space-y-24">
  ...
  <div
    class="flex w-full items-center justify-center space-x-2 md:space-x-32 p-2 sm:p-10"
  >
    <div class="relative group">
      ...
      />
      <div
        class="absolute bottom-0 left-0 flex flex-col space-y-2.5 z-10 cursor-pointer group-hover:pb-8 transition-all duration-300"
      >
